...
const Combine = ({ combineConference }) => {
    return (
        <div onClick={combineConference}
             className="combine-conference-button d-flex flex-column px-2 align-items-center justify-content-center">

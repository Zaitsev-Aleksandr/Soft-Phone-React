...
const VirtualMonitorBlock = () => {
    return (
        <div className="virtual-monitor-block overflow-hidden d-flex flex-column ">
            <div className="d-flex flex-column align-items-center justify-content-between h-100">

                <div className="timer-input d-flex flex-nowrap align-items-center w-100">
                    <i className="far fa-clock mr-3"/>
                    <CommonSpan className="local-time-value mr-3" clientValue={new Date().toLocaleTimeString()}/>
                    Статус:
